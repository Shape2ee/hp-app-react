...
const ImpactList = () => {
  const data = [
    {
      title: (<h3>2,740그루의<span className='block'>나무를 심었습니다.</span></h3>),
      src: ico1
    },
    {
      title: (<h3>22,968명의<span className='block'>학습자 활성화.</span></h3>),
      src: ico2
    },
    {
      title: (<h3>352톤의 소모품 및<span className='block'>하드웨어 재활용.</span></h3>),
      src: ico3
    },
    {
      title: (<h3>다양한<span className='block'>공급업체와 함께.</span></h3>),
      src: ico4
    },
  ]
